...
int main()
{
    FILE* fptr = stdout; // Default to stdout if OUTPUT_PATH is not set
    ...
    for (int t_itr = 0; t_itr < t; t_itr++) {
        ...
        free(llist); // Also free the DoublyLinkedList wrapper
    }
...
char* readline() {
    ...
    data = realloc(data, data_length + 1); // Ensure space for null terminator
